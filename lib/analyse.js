  ...
  async.parallel({
    ...
    _.each(a.countries, function(ratingAGave, country){
      if (b.countries.hasOwnProperty(country)){
        ...
        countriesInCommon[country].desc = aUtils.describe(diff);
      }
    });
    ...
    _.each(a.beers, function(ratingObj, beer){
      ...
      if (b.beers.hasOwnProperty(beer)){
        ...
        beersInCommon[beer].desc = aUtils.describe(diff);
      }
    });
    ...
    return cb(null, {
      ...
      styleDesc : aUtils.describe(averageStyleDifference), 
      beerDesc : aUtils.describe(averageBeerDifference),
      match : match,
